...
class DataPaginatorTheme extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  const DataPaginatorTheme({Key? key, required this.data, required this.child})
      : super(key: key, child: child);

  /// Specifies the color and typography values for descendant [SfDataPager]
  /// widgets.
  final DataPaginatorThemeData data;

  /// The widget below this widget in the tree.
  @override
  final Widget child;

  /// The data from the closest [DataPaginatorTheme]
  /// instance that encloses the given context.
  ///
  /// Defaults to [CoreThemeData.dataPagerThemeData] if there
  /// is no [DataPaginatorTheme] in the given build context.
  static DataPaginatorThemeData? of(BuildContext context) {
    final DataPaginatorTheme? dataPaginatorTheme =
        context.dependOnInheritedWidgetOfExactType<DataPaginatorTheme>();
    return dataPaginatorTheme?.data ??
        CoreTheme.of(context).dataPaginatorThemeData;
  }

  @override
  bool updateShouldNotify(DataPaginatorTheme oldWidget) =>
      data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final DataPaginatorTheme? ancestorTheme =
        context.findAncestorWidgetOfExactType<DataPaginatorTheme>();
    return identical(this, ancestorTheme)
        ? child
        : DataPaginatorTheme(data: data, child: child);
  }
}

/// Holds the color and typography values for a [DataPaginatorTheme]. Use
///  this class to configure a [DataPaginatorTheme] widget
///
/// To obtain the current theme, use [DataPaginatorTheme.of].
class DataPaginatorThemeData with Diagnosticable {
  /// Create a [DataPaginatorThemeData] that's used to configure a
  /// [DataPaginatorTheme].
  factory DataPaginatorThemeData(
    ...
    return DataPaginatorThemeData.raw(
        brightness: brightness,
  ...
  /// Create a [DataPaginatorThemeData] given a set of exact values.
  /// All the values must be specified.
  ///
  /// This will rarely be used directly. It is used by [lerp] to
  /// create intermediate themes based on two themes created with the
  /// [DataPaginatorThemeData] constructor.
  const DataPaginatorThemeData.raw(
  ...
  DataPaginatorThemeData copyWith(
      {Brightness? brightness,
      Color? backgroundColor,
      Color? itemColor,
      TextStyle? itemTextStyle,
  ...
  static DataPaginatorThemeData? lerp(
      DataPaginatorThemeData? a, DataPaginatorThemeData? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return DataPaginatorThemeData(
  ...
  bool operator ==(Object other) {
    ...
    return other is DataPaginatorThemeData &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final DataPaginatorThemeData defaultData = DataPaginatorThemeData();
