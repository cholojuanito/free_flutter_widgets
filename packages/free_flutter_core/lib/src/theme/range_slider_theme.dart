...
import '../../core_theme.dart' as core_theme;

/// Applies a theme to descendant Syncfusion range slider widgets.
class RangeSliderTheme extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const RangeSliderTheme({Key? key, required this.data, required this.child})
      : super(key: key, child: child);

  /// Specifies the color and typography values for
  /// descendant range slider widgets.
  final RangeSliderThemeData data;

  /// Specifies a widget that can hold single child.
  @override
  final Widget child;

  /// The data from the closest [RangeSliderTheme] instance
  /// that encloses the given context.
  ///
  /// Defaults to [CoreThemeData.rangeSliderThemeData] if there is no
  /// [RangeSliderTheme] in the given build context.
  static RangeSliderThemeData? of(BuildContext context) {
    final RangeSliderTheme? rangeSliderTheme =
        context.dependOnInheritedWidgetOfExactType<RangeSliderTheme>();
    return rangeSliderTheme?.data ??
        core_theme.CoreTheme.of(context).rangeSliderThemeData;
  }

  @override
  bool updateShouldNotify(RangeSliderTheme oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final RangeSliderTheme? ancestorTheme =
        context.findAncestorWidgetOfExactType<RangeSliderTheme>();
    return identical(this, ancestorTheme)
        ? child
        : RangeSliderTheme(data: data, child: child);
  }
}

/// Holds the color and typography values for a [RangeSliderTheme].
/// Use this class to configure a [RangeSliderTheme] widget, or to set the
/// [CoreThemeData.rangeSliderThemeData] for a [CoreTheme] widget.
///
/// To obtain the current theme, use [RangeSliderTheme.of].
///
...
class RangeSliderThemeData extends core_theme.SliderThemeData {
  /// Returns a new instance of [RangeSliderThemeData.raw]
  /// for the given values.
  ///
  /// If any of the values are null, the default values will be set.
  factory RangeSliderThemeData(
    ...
    return RangeSliderThemeData.raw(
        brightness: brightness,
  ...
  /// Create a [RangeSliderThemeData] given a set of exact values.
  /// All the values must be specified.
  ///
  /// This will rarely be used directly. It is used by [lerp] to
  /// create intermediate themes based on two themes created with the
  /// [RangeSliderThemeData] constructor.
  const RangeSliderThemeData.raw({
  ...
  static RangeSliderThemeData? lerp(
      RangeSliderThemeData? a, RangeSliderThemeData? b, double t) {
    if (a == null && b == null) {
      return null;
    }
  ...
  bool operator ==(Object other) {
    ...
    return other is RangeSliderThemeData &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final RangeSliderThemeData defaultData = RangeSliderThemeData();
