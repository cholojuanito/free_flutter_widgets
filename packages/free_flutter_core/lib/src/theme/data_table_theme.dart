...
/// }
/// ```
class DataTableTheme extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  const DataTableTheme({Key? key, required this.data, required this.child})
  ...
  /// The data from the closest [DataTableTheme]
  /// instance that encloses the given context.
  ///
  /// Defaults to [CoreThemeData.tableThemeData] if there
  /// is no [DataTableTheme] in the given build context.
  ///
  static DataTableThemeData of(BuildContext context) {
    ...
    return dataTableTheme?.data ?? CoreTheme.of(context).dataTableThemeData;
  }
  ...
  Widget wrap(BuildContext context, Widget child) {
    final DataTableTheme? ancestorTheme =
        context.findAncestorWidgetOfExactType<DataTableTheme>();
    return identical(this, ancestorTheme)
        ? child
        : DataTableTheme(data: data, child: child);
  }
}

/// Holds the color and typography values for a [DataTableTheme]. Use
///  this class to configure a [DataTableTheme] widget
///
/// To obtain the current theme, use [DataTableTheme.of].
///
/// ```dart
/// Widget build(BuildContext context) {
///   return Scaffold(
...
class DataTableThemeData with Diagnosticable {
  /// Create a [DataTableThemeData] that's used to configure a
  /// [DataTableTheme].
  factory DataTableThemeData({
  ...
  /// Create a [DataTableThemeData] given a set of exact values.
  ...
  ///       child: CoreTheme(
  ///         data: CoreThemeData(
  ///           tableThemeData: DataTableThemeData(
  ///             brightness: Brightness.dark
  ///           )
  ///         ),
  ///         child: SfDataGrid(),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final DataTableThemeData defaultData = DataTableThemeData();
