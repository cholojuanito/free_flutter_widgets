...
///
/// To obtain the current theme, use [PdfViewerTheme.of].
///
/// ```dart
...
/// }
/// ```
class PdfViewerTheme extends InheritedTheme {
  /// Creates an argument constructor of [PdfViewerTheme] class.
  const PdfViewerTheme({Key? key, required this.data, required this.child})
  ...
  /// The data from the closest [PdfViewerTheme] instance that encloses the given
  /// context.
  ///
  /// Defaults to [CoreThemeData.pdfViewerThemeData] if there is no [PdfViewerTheme]
  /// in the given build context.
  ///
  static PdfViewerThemeData? of(BuildContext context) {
    final PdfViewerTheme? pdfViewerTheme =
        context.dependOnInheritedWidgetOfExactType<PdfViewerTheme>();
    return pdfViewerTheme?.data ?? CoreTheme.of(context).pdfViewerThemeData;
  }
  ...
  Widget wrap(BuildContext context, Widget child) {
    final PdfViewerTheme? ancestorTheme =
        context.findAncestorWidgetOfExactType<PdfViewerTheme>();
    return identical(this, ancestorTheme)
        ? child
        : PdfViewerTheme(data: data, child: child);
  }
}

/// Holds the color and typography values for a [PdfViewerTheme]. Use
/// this class to configure a [PdfViewerTheme] widget.
///
/// To obtain the current theme, use [PdfViewerTheme.of].
///
/// ```dart
...
/// }
/// ```
class PdfViewerThemeData with Diagnosticable {
  /// Creating an argument constructor of PdfViewerThemeData class.
  factory PdfViewerThemeData(
  ...
  /// Create a [PdfViewerThemeData] given a set of exact values.
  /// All the values must be specified.
  ///
  /// This will rarely be used directly. It is used by [lerp] to
  /// create intermediate themes based on two themes created with the
  /// [PdfViewerThemeData] constructor.
  ///
  const PdfViewerThemeData.raw({
  ...
  bool operator ==(Object other) {
    ...
    return other is PdfViewerThemeData &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final PdfViewerThemeData defaultData = PdfViewerThemeData();
