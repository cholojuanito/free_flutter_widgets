...
/// }
/// ```
class MapTheme extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const MapTheme({Key? key, required this.data, required this.child})
  ...
  /// The data from the closest [MapTheme] instance
  /// that encloses the given context.
  ///
  /// Defaults to [CoreThemeData.mapsThemeData] if there is no
  /// [MapTheme] in the given build context.
  static MapThemeData? of(BuildContext context) {
    final MapTheme? mapsTheme =
        context.dependOnInheritedWidgetOfExactType<MapTheme>();
    return mapsTheme?.data ?? CoreTheme.of(context).mapThemeData;
  }

  @override
  bool updateShouldNotify(MapTheme oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final MapTheme? ancestorTheme =
        context.findAncestorWidgetOfExactType<MapTheme>();
    return identical(this, ancestorTheme)
        ? child
        : MapTheme(data: data, child: child);
  }
}

/// Holds the color and typography values for a [MapTheme]. Use this class
/// to configure a [MapTheme] widget, or to set the
/// [CoreThemeData.mapsThemeData] for a [CoreTheme] widget.
///
/// To obtain the current theme, use [MapTheme.of].
///
...
/// }
/// ```
class MapThemeData with Diagnosticable {
  /// Returns a new instance of [MapThemeData.raw] for the given values.
  ///
  /// If any of the values are null, the default values will be set.
  factory MapThemeData({
  ...
  /// Create a [MapThemeData] given a set of exact values.
  /// All the values must be specified.
  ///
  /// This will rarely be used directly. It is used by [lerp] to
  /// create intermediate themes based on two themes created with the
  /// [MapThemeData] constructor.
  const MapThemeData.raw({
  ...
  static MapThemeData? lerp(MapThemeData? a, MapThemeData? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return MapThemeData(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final MapThemeData defaultData = MapThemeData();
