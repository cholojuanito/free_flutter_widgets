...
///
/// To obtain the current theme, use [ChartTheme.of].
///
/// ```dart
...
class ChartTheme extends InheritedTheme {
  /// Creating an argument constructor of ChartTheme class.
  const ChartTheme({Key? key, required this.data, required this.child})
  ...
  /// The data from the closest [ChartTheme] instance that encloses the given
  /// context.
  ///
  /// Defaults to [CoreThemeData.chartThemeData] if there is no [ChartTheme]
  /// in the given build context.
  ///
  static ChartThemeData of(BuildContext context) {
    final ChartTheme? sfChartTheme =
        context.dependOnInheritedWidgetOfExactType<ChartTheme>();
    return sfChartTheme?.data ?? CoreTheme.of(context).chartThemeData;
  }
  ...
  Widget wrap(BuildContext context, Widget child) {
    final ChartTheme? ancestorTheme =
        context.findAncestorWidgetOfExactType<ChartTheme>();
    return identical(this, ancestorTheme)
        ? child
        : ChartTheme(data: data, child: child);
  }
}

/// Holds the color and typography values for a [ChartTheme]. Use
///  this class to configure a [ChartTheme] widget.
///
/// To obtain the current theme, use [ChartTheme.of].
///
/// ```dart
...
class ChartThemeData with Diagnosticable {
  ...
  /// Create a [ChartThemeData] given a set of exact values.
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final ChartThemeData defaultData = ChartThemeData();
