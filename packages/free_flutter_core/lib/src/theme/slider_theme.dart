...
class SliderTheme extends InheritedTheme {
  ...
  const SliderTheme({Key? key, required this.data, required this.child})
  ...
  /// The data from the closest [SliderTheme] instance
  /// that encloses the given context.
  ///
  /// Defaults to [CoreThemeData.sliderThemeData] if there is no
  ...
  static SliderThemeData of(BuildContext context) {
    ...
    return sliderTheme?.data ?? CoreTheme.of(context).sliderThemeData;
  }
...
/// Holds the color and typography values for a [SliderTheme]. Use this class
/// to configure a [SliderTheme] widget, or to set the
/// [CoreThemeData.sliderThemeData] for a [CoreTheme] widget.
///
/// To obtain the current theme, use [SliderTheme.of].
///
...
/// See also:
///
///  * [CoreTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/CoreTheme-class.html) and
/// [CoreThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/CoreThemeData-class.html),
/// for customizing the visual appearance of the slider.
class SliderThemeData with Diagnosticable {
  /// Returns a new instance of [SliderThemeData.raw] for the given values.
  ///
  /// If any of the values are null, the default values will be set.
  factory SliderThemeData(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SliderThemeData defaultData = SliderThemeData();
  ...
  /// added as children of [SliderTheme].
  ///
