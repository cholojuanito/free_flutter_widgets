...
/// Defines the localized resource values used by the Free Flutter Widgets.
///
/// See also:
///
///  * [GlobalLocalizations], which provides localizations for many languages.
///
abstract class Localization {
  ...
  /// The `Localization` from the closest [Localizations] instance
  ...
  ///
  /// ```dart
  /// String label = Localization.of(context).noSelectedDateCalendarLabel,
  /// ```
  ///
...
class _LocalizationDelegate extends LocalizationsDelegate<Localization> {
  ...
  @override
  Future<Localization> load(Locale locale) => _DefaultLocalization.load(locale);
...
class _DefaultLocalization implements Localization {
  const _DefaultLocalization();
  ...
  static Future<Localization> load(Locale locale) {
    return SynchronousFuture<Localization>(const _DefaultLocalization());
  }
