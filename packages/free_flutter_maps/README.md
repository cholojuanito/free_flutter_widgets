![free_flutter_map_banner](https://cdn.syncfusion.com/content/images/Flutter/pub_images/maps_images/banner.jpg)
...
Install the latest version from [pub](https://pub.dev/packages/free_flutter_maps#-installing-tab-).
...
```dart
import 'package:free_flutter_maps/maps.dart';
```
