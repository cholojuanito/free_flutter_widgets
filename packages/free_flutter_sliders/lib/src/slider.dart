...
///
/// Slider can be customized using the [SfSliderTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderTheme-class.html) with the help of [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), or the [SfTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/SfTheme-class.html) with the help of [SfThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfThemeData-class.html).
/// It is also possible to override the appearance using [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html) which were set using the properties of the widget like [activeColor] and [inactiveColor].
///
/// ## Example
///
...
/// See also:
///
/// * [SfTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/SfTheme-class.html) and [SfThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfThemeData-class.html), for customizing the visual appearance of the slider.
/// * [numberFormat] and [dateFormat], for formatting the numeric and
/// date labels.
/// * [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), for customizing the visual appearance of the slider.
class SfSlider extends StatefulWidget {
  ...
  ///
  /// * [showTicks], to render major ticks at given interval.
  /// * [minorTickShape] and [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), for customizing
  ...
  /// See also:
  ///
  /// * [tickShape] and [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html) for customizing the
  ...
  /// * [numberFormat] and [dateFormat], for formatting the numeric and
  /// date labels.
  /// * [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), for customizing the appearance of the labels.
  ...
  /// * [showTicks], to render major ticks at given interval.
  /// * [showLabels], to render labels at given interval.
  /// * [divisorShape] and [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html) for customizing
  ...
  /// * [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), for customizing the appearance of the tooltip text.
  ...
  /// See also:
  ///
  /// * [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), for customizing the individual
  ...
  /// See also:
  ///
  /// * [SfSliderThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfSliderThemeData-class.html), for customizing the individual active slider element’s visual.
