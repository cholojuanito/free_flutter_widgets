...
/// It accepts any type of framework widget or custom widget like [SfChart](https://pub.dev/documentation/free_flutter_charts/latest/charts/charts-library.html) as a child.
///
...
///
/// Range selector can be customized using the [SfRangeSelectorTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorTheme-class.html) with the help of [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html),
/// or the [SfTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/SfTheme-class.html) with the help of [SfThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfThemeData-class.html).
/// It is also possible to override the appearance using [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html)
...
/// See also:
///
/// * [SfTheme](https://pub.dev/documentation/free_flutter_core/latest/theme/SfTheme-class.html) and [SfThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfThemeData-class.html), for customizing the visual appearance of the range selector.
/// * [numberFormat] and [dateFormat], for formatting the
/// numeric and date labels.
/// * [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html), for customizing the visual appearance of the range selector.
/// * [RangeController](https://pub.dev/documentation/free_flutter_core/latest/core/RangeController-class.html), for coordinating between [SfRangeSelector] and the widget which listens to it.
/// * [SfChart](https://pub.dev/documentation/free_flutter_charts/latest/charts/charts-library.html) and [RangeController](https://pub.dev/documentation/free_flutter_core/latest/core/RangeController-class.html), for selection and zooming.
class SfRangeSelector extends StatefulWidget {
  ...
  ///
  /// Built-in support for selection and zooming with [SfChart](https://pub.dev/documentation/free_flutter_charts/latest/charts/charts-library.html).
  ///
  ...
  ///
  /// ## Selection in [SfChart](https://pub.dev/documentation/free_flutter_charts/latest/charts/charts-library.html).
  ///
  /// ```dart
  ...
  /// ```
  ///
  /// ## Zooming in [SfChart](https://pub.dev/documentation/free_flutter_charts/latest/charts/charts-library.html).
  ///
  /// ```dart
  ...
  ///
  /// * [showTicks] to render major ticks at given interval.
  /// * [minorTickShape] and [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html) for customizing
  ...
  /// See also:
  ///
  /// * [tickShape] and [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html) for customizing the
  ...
  /// * [numberFormat] and [dateFormat] for formatting the
  /// numeric and date labels.
  /// * [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html) to customize the appearance of the labels.
  ...
  /// * [showTicks], to render major ticks at given interval.
  /// * [showLabels], to render labels at given interval.
  /// * [divisorShape] and [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html) for customizing
  ...
  /// * [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html), for customizing the appearance of the tooltip text.
  ...
  /// See also:
  ///
  /// * [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html), for customizing the individual
  ...
  /// See also:
  ///
  /// * [SfRangeSelectorThemeData](https://pub.dev/documentation/free_flutter_core/latest/theme/SfRangeSelectorThemeData-class.html), for customizing the individual active range selector element’s visual.
