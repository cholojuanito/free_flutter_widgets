...
///
/// You can customize the [SignatureBox] with below options.
...
/// * The stroke color of the [SignatureBox] can be customized using the
/// [strokeColor] property.
/// * The background color of the [SignatureBox] can be customized using the
/// [backgroundColor] property.
///
/// The [onSignStart] and [onSignEnd] allows you to handle the gestures
/// in [SignatureBox]
///
/// The [toImage] allows you to export the signature in [SignatureBox] to an
/// image.
/// The [clear] allows you to clear all the signature strokes in
/// [SignatureBox].
/// The [renderToContext2D] allows you to export the signature in
/// [SignatureBox] to a html canvas. [renderToContext2D] is used to export the
/// signature as an image in web platform.
///
/// Note - Since the [toImage], [clear] and [renderToContext2D] are defined in
/// state object of [SignatureBox], you have to use a global key assigned to
/// the [SignatureBox] instance to call these methods.
///
/// ## Example
///
/// This snippet shows how to use a [SignatureBox].
///
/// * Create a global key for [SfSignaturePadState].
/// ```dart
/// final GlobalKey<SfSignaturePadState> _signaturePadKey = GlobalKey();
/// ```
/// * Create the [SignatureBox] and set the properties and global key.
/// ```dart
/// SfSignaturePad(
...
///  );
///  ```
/// * Handle the start and completion of signature gestures in [SignatureBox]
...
class SignatureBox extends StatefulWidget {
  /// Constructor that creates a new instance of [SignatureBox].
  ///
  /// The below snippet shows how to use a [SignatureBox].
  ///
  /// * Create a global key.
  /// ```dart
  /// final GlobalKey<SfSignaturePadState> _signaturePadKey = GlobalKey();
  ///```
  /// * Create a [SignatureBox] and set the properties and global key.
  /// ```dart
  /// SfSignaturePad(
  ///   minimumStrokeWidth: 3.0,
  ///   maximumStrokeWidth: 6.0,
  ...
  /// ui.Image image = await _signaturePadKey.currentState.toImage();
  /// ```
  /// * Handle the start of signature gestures in [SignatureBox] from
  /// [onSignStart].
  /// ```dart
  /// SfSignaturePad(
  ///   onSignStart: ()=> {
  ...
  ///   });
  /// ```
  /// * Handle the end of signature gestures in [SignatureBox] from
  /// [onSignEnd].
  /// ```dart
  ///  SfSignaturePad(
  ///    onSignEnd: ()=> {
  ...
  ///
  /// The stroke will be drawn in [SignatureBox] based on the speed of the
  /// stroke gesture within its minimum and maximum stroke width ranges.
  /// So that the signature will be more realistic.
  ///
  /// This snippet shows how to set stroke width in [SignatureBox].
  ///
  /// ```dart
  /// SfSignaturePad(
  ///   minimumStrokeWidth: 3.0,
  ...
  /// So that the signature will be more realistic.
  ///
  /// This snippet shows how to set the stroke width in [SignatureBox].
  ///
  /// ```dart
  /// SfSignaturePad(
  ///   minimumStrokeWidth: 3.0,
  ...
  /// Color applied to the background of [SignatureBox].
  ///
  /// The default [backgroundColor] is `Colors.transparent`.
  ///
  /// This snippet shows how to set a background color for [SignatureBox].
  ///
  /// ```dart
  /// SfSignaturePad(
  ///   backgroundColor: Colors.white,
  ...
  ///
  /// This snippet shows how to set the stroke color for [SignatureBox].
  ///
  /// ```dart
  ///
  /// SfSignaturePad(
  ...
  /// Called when the user starts signing on [SignatureBox].
  ///
  /// This snippet shows how to set [onSignStart] callback in [SignatureBox].
  ///
  /// ```dart
  /// SfSignaturePad(
  ///   onSignStart: ()=> {
  ...
  /// Called when the user completes signing on [SignatureBox].
  ///
  /// This snippet shows how to set [onSignEnd] callback in [SignatureBox].
  ///
  /// ```dart
  ///
  /// SfSignaturePad(
...
/// This class maintains the state of the [SignatureBox] widget.
class SfSignaturePadState extends State<SignatureBox> {
  /// Saves the signature as an image.
  /// Returns the [ui.Image].
  ///
  /// Since this method is defined in the state object of [SignatureBox],
  /// you have to use a global key assigned to the [SignatureBox] instance
  /// to call this method.
  ///
  ...
  /// final GlobalKey<SfSignaturePadState> _signaturePadKey = GlobalKey();
  ///```
  /// * Create a [SignatureBox] and assign the global key to it.
  /// ```dart
  /// SfSignaturePad(
  ///   key: _signaturePadKey,
  ///  );
  ...
  /// Clears all the signature strokes in the [SignatureBox].
  ///
  /// Since this method is defined in the state object of [SignatureBox],
  /// you have to use a global key assigned to the [SignatureBox] to call this
  /// method.
  ...
  /// final GlobalKey<SfSignaturePadState> _signaturePadKey = GlobalKey();
  ///```
  /// * Create a [SignatureBox] instance and assign the global key to it.
  /// ```dart
  /// SfSignaturePad(
  ///   key: _signaturePadKey,
  ///  );
...
/// A render object for [SignatureBox] widget.
