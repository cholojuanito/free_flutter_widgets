![free_flutter_gauge_banner](https://cdn.syncfusion.com/content/images/FTControl/Charts/Flutter-radial-linear-gauge.png)
...
Install the latest version from [pub](https://pub.dartlang.org/packages/free_flutter_gauges#-installing-tab-).
...
```dart
import 'package:free_flutter_gauges/gauges.dart';
```
