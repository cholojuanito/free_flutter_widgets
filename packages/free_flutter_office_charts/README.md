![free_flutter_officechart_banner](https://cdn.syncfusion.com/content/images/Flutter-OfficeChart-Banner.png)
...
Install the latest version from [pub](https://pub.dev/packages/free_officechart/install)
