![free_flutter_xlsio_banner](https://cdn.syncfusion.com/content/images/FTControl/Flutter-XlsIO-Banner.png)
...
Install the latest version from [pub](https://pub.dev/packages/free_flutter_xlsio/install)
...
```dart
import 'package:free_flutter_xlsio/xlsio.dart';
...
```dart
import 'package:free_officechart/officechart.dart';
