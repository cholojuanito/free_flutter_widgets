library free_flutter_pdfviewer_platform_interface;

import 'dart:async';
import 'dart:typed_data';
import 'package:plugin_platform_interface/plugin_platform_interface.dart';
import 'package:free_flutter_pdfviewer_platform_interface/src/method_channel_pdfviewer.dart';

/// The interface that implementations of free_flutter_pdfviewer must implement.
///
/// Platform implementations should extend this class rather than implement it as `free_flutter_pdfviewer`
