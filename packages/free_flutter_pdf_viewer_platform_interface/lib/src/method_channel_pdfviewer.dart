...
import 'package:free_flutter_pdfviewer_platform_interface/pdfviewer_platform_interface.dart';

class MethodChannelPdfViewer extends PdfViewerPlatform {
  final MethodChannel _channel = MethodChannel('free_flutter_pdfviewer');
